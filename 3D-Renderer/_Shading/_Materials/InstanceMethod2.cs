...
{
    internal class InstanceMethod2 : Material
    {
        public Color4 color;
        ...
        public InstanceMethod2(Color4 color)
            : base(new Shader(@"../../../_Assets/_Built-In/_Shaders/_Instanced/particle_method2.vert",
                @"../../../_Assets/_Built-In/_Shaders/_Instanced/particle.frag"))
        {
            ...
            UL_transformationMatrices = new int[1000];
